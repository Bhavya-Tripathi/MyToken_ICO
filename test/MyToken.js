...
contract('MyToken', function(accounts){
    ...
    it('handles delegate transfer', function(){
        return MyToken.deployed().then(function(instance){
            ...
            assert(error.message.indexOf('revert') >= 0, 'cannot transfer value largr than approved amount');
            ...
            assert.equal(balance.toNumber(), 90, 'deducts the amount from spending account');
