...
contract('MyTokenSale', function(accounts){
    ...
    it('inititalizes the contract with the correct values',function(){
        return MyTokenSale.deployed().then(function(instance){
            tokenSaleInstance = instance;
            return tokenSaleInstance.address
        }).then(function(address){
            // we dont want the address to be 0 value
    ...
    it('facilitates token buying', function(){
        ...
        // to check that the number of tokens sold is equal to the amount of tokens bought
    ...
    it('ends token sale', function(){
        return MyToken.deployed().then(function(instance){
            ...
            // then grab token sale instance
            tokenSaleInstance = instance;
            // Try to end sale frokm account other than the admin
            ...
            assert.equal(balanceContract.toNumber(), 0, 'token price was reset');
        });
    });
});